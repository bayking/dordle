...
describe('Scheduler Timezone', () => {
  describe('isTargetHourInTimezone', () => {
    it('Given UTC timezone and 9 AM UTC, When checking for hour 9, Then returns true', () => {
      const date = new Date('2024-01-15T09:00:00Z');
      expect(isTargetHourInTimezone(date, 'UTC', 9)).toBe(true);
    });

    it('Given UTC timezone and 10 AM UTC, When checking for hour 9, Then returns false', () => {
      const date = new Date('2024-01-15T10:00:00Z');
      expect(isTargetHourInTimezone(date, 'UTC', 9)).toBe(false);
    });

    it('Given Europe/London and 9 AM UTC in summer (BST), When checking for hour 9, Then returns false', () => {
    ...
    it('Given Europe/London and 8 AM UTC in summer (BST), When checking for hour 9, Then returns true', () => {
    ...
    it('Given America/New_York and 14:00 UTC, When checking for hour 9, Then returns true', () => {
    ...
    it('Given invalid timezone, When checking, Then defaults to UTC', () => {
      const date = new Date('2024-01-15T09:00:00Z');
  ...
  describe('getDayOfWeekInTimezone', () => {
    it('Given UTC timezone, When getting day of week, Then returns correct day', () => {
      // 2024-01-15 is a Monday (day 1)
      const date = new Date('2024-01-15T12:00:00Z');
      expect(getDayOfWeekInTimezone(date, 'UTC')).toBe(1);
    });

    it('Given timezone where date crosses midnight, When getting day, Then returns correct local day', () => {
    ...
    it('Given Sunday, When getting day of week, Then returns 0', () => {
  ...
  describe('getDayOfMonthInTimezone', () => {
    it('Given UTC timezone, When getting day of month, Then returns correct day', () => {
      const date = new Date('2024-01-15T12:00:00Z');
    ...
    it('Given first of month, When getting day, Then returns 1', () => {
